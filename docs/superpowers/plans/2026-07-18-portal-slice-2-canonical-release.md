...
- Verification passed: fresh `0001`–`0007`, representative full-state `0005`→`0006`→`0007` upgrade, SQL assertions, real-JWT/PostgREST two-tenant suite, fixture preview/apply/exact retry, 47 unit tests, scoped ESLint, `git diff --check`, design-system build, and Next 15 production build.
