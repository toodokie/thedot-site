...
- **Source of truth:** Figma "The Dot Styleguide" (`26JZoEUiX2geZRTPjfcgXq`) > site CSS. Palette = the 6 colors above. **Synced to Claude Design** project "The Dot Creative — Design System" — re-sync with `/design-sync` (config in `.design-sync/`). Spec + plan: `docs/superpowers/`.
