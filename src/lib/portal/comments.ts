...
const SELECT = 'id, content_version, copy_block_key, author_type, author_name, body, quoted_text, target_kind, target_url, reply_to_comment_id, resolved, created_at'
