...
vi.mock('./notify', () => ({ sendPortalNotificationEmail: sendMail }))
...
describe('drainPortalNotifications', () => {
  it('routes client rows to their resolved recipient and agency rows to AGENCY_EMAIL', async () => {
    ...
    const admin = adminFor([
      { id: 'client-1', claim_token: 11, recipient_kind: 'client', recipient_email: 'maria@kanset.com', subject: 'Client', body: 'Review', related_url: null },
      { id: 'agency-1', claim_token: 12, recipient_kind: 'agency', recipient_email: null, subject: 'Agency', body: 'Reply', related_url: null },
    ])
  ...
  it('fails and fences a client row with no resolved recipient instead of falling back to agency', async () => {
    sendMail.mockClear()
    const admin = adminFor([
      { id: 'client-2', claim_token: 21, recipient_kind: 'client', recipient_email: null, subject: 'Client', body: 'Review', related_url: null },
    ])
