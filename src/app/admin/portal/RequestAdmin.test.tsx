...
function request(overrides: Partial<AdminContentRequest> = {}): AdminContentRequest {
  return {
    ...
    edit: { targetKind: 'copy_block', targetKey: 'social-caption',
      targetLabel: 'Instagram + Facebook caption', targetUrl: null,
      blockKey: 'social-caption', blockLabel: 'Instagram + Facebook caption',
