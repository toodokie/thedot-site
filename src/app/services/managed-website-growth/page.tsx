...
const data: ServicePageData = {
  ...
  lede: 'A website isn&rsquo;t &ldquo;done&rdquo; at launch &mdash; it drifts. Pages slow down, content goes stale, competitors move, and the way customers find you keeps changing. Managed growth keeps your site fast, accessible, findable and converting, month after month, instead of a one-time build that quietly ages.',
  ctas: [
  ...
  why: {
    ...
    body: 'Search changes, AI answers change, your offer changes, and content accumulates. Without upkeep, speed slips, accessibility regresses, and you gradually fall out of the results &mdash; human and AI. Managed growth is the difference between a site that compounds and one that decays.',
  },
  covers: {
    heading: 'What&rsquo;s included',
    cards: [
      { title: 'Performance & Core Web Vitals', body: 'We keep the site fast &mdash; speed, LCP and stability &mdash; because slow pages quietly cost you customers and rankings.' },
      ...
      { title: 'AI-visibility upkeep', body: 'Keeping you findable in AI answers as the assistants change &mdash; see <a href="/services/ai-visibility-audit">AI Visibility</a>.' },
      { title: 'Accessibility maintenance', body: 'Accessibility drifts as content changes; we keep it holding to standard.' },
      { title: 'Reporting you&rsquo;ll actually read', body: 'A short monthly view of what changed and what it moved &mdash; not a data dump.' },
    ],
  },
  how: {
    heading: 'How it works',
    steps: [
      { title: 'Baseline', body: 'We measure where the site stands today &mdash; speed, accessibility, conversion, visibility.' },
  ...
  faqs: {
    ...
    items: [
      ...
      { q: 'Is this a monthly retainer?', a: 'Yes &mdash; it&rsquo;s an ongoing arrangement, because the point is continuous improvement rather than a one-off project.' },
      ...
      { q: 'What results can I expect?', a: 'That depends on where you&rsquo;re starting &mdash; the honest answer is steady, compounding gains in speed, accessibility, findability and conversion, measured monthly, not a magic overnight jump.' },
    ],
  },
  final: {
