...
const data: ServicePageData = {
  ...
  why: {
    ...
    body: 'Manual work feels free until you count the hours, the mistakes from re-keying the same data, and the leads that slip because a follow-up didn&rsquo;t happen. Automating the repetitive parts doesn&rsquo;t replace your team; it gives them back the time to do the work that actually needs a human.',
  },
  covers: {
    heading: 'What we automate',
    cards: [
      { title: 'Client intake', body: 'A form submission becomes a qualified lead, a CRM record and a first response, without anyone re-typing it.' },
      ...
      { title: 'No more double entry', body: 'Stop copying the same customer details between apps. Enter it once, and it lands everywhere it needs to go.' },
      ...
      { title: 'Built on your real stack', body: 'We automate around the tools you already run. No rip-and-replace.' },
    ],
  },
  how: {
    ...
    steps: [
      ...
      { title: 'Design the automation', body: 'We design the flows: what triggers what, and where a human still decides.' },
  ...
  faqs: {
    ...
    items: [
      { q: 'What kinds of things can you automate?', a: 'Client intake, lead routing, data sync between apps, approvals, reminders, invoicing hand-offs and recurring reports are the common ones. We always start by mapping <em>your</em> workflows, though, not a template.' },
      { q: 'Which tools do you connect?', a: 'The tools you already run: CRMs, QuickBooks and other accounting, booking and scheduling systems, and intake forms. The point is to connect, not replace.' },
      { q: 'Will this break my current setup?', a: 'No. We map what you have first, build carefully, and stay on for a 90-day optimisation window to tune it against how you actually work.' },
...
export default function Route() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema(slug, 'Workflow Automation')) }} />
