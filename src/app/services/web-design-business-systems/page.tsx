...
const data: ServicePageData = {
  ...
  lede: 'A great website is where customers meet you. But a site that&rsquo;s cut off from the tools you actually run still leaves you doing the busywork by hand. We design accessible, conversion-focused websites for Ontario businesses, then connect them to the systems behind them.',
  ctas: [
  ...
  why: {
    ...
    body: 'Most small businesses run a website, a CRM, an accounting tool, a scheduler and an intake form, and none of them talk to each other. So the same information gets re-typed, leads slip, and hours disappear into admin. We design the website as the front end of one connected system, so the work flows instead of piling up.',
  },
  covers: {
    heading: 'What we build',
    cards: [
      { title: 'Strategic website design', body: 'Custom, mobile-first design built around your customers and how they actually decide.' },
      ...
      { title: 'Workflow automation', body: 'The manual, repetitive steps in your client and admin work get automated. <a href="/services/workflow-automation">More on automation</a>.' },
      { title: 'Accessibility built in', body: 'AODA/WCAG accessibility from the start, not bolted on afterward. <a href="/services/aoda-web-accessibility">More on AODA</a>.' },
  ...
  how: {
    ...
    steps: [
      ...
      { title: 'Design & build', body: 'We design and build the site: accessible, on-brand and built to convert.' },
  ...
  faqs: {
    ...
    items: [
      { q: 'What does a “connected business system” actually mean?', a: 'It means your website isn&rsquo;t a standalone brochure. It&rsquo;s wired into your CRM, accounting, scheduling and intake tools, with the repetitive steps between them automated. One system instead of five that don&rsquo;t talk.' },
      { q: 'How much does a website cost?', a: 'A Professional Foundation website runs $2,500&ndash;$4,500. A fully Connected Business System (site plus integration plus automation) runs $5,500&ndash;$7,500. Every project is scoped, so <a href="/brief">start a brief</a> for a real quote.' },
      { q: 'Do you work with the tools I already use?', a: 'Yes. The goal is to connect what you already run (QuickBooks, your CRM, booking and intake tools), not to make you switch everything.' },
      { q: 'Is accessibility included?', a: 'Accessibility (AODA/WCAG) is built into every site we design. We also audit existing sites: see our <a href="/services/aoda-web-accessibility">AODA service</a>.' },
    ],
  },
  final: {
