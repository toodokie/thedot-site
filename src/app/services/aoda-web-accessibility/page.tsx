...
const data: ServicePageData = {
  ...
  lede: 'Under the AODA, many Ontario organizations&rsquo; websites are expected to meet WCAG accessibility standards. We build accessibility in from the first design decision &mdash; and for sites you already have, we run a practical audit with a prioritized list of what to fix and how.',
  ctas: [
  ...
  why: {
    ...
    body: 'An accessible site works for people using screen readers, keyboards, magnification or just a small phone in bright sun &mdash; which is to say, more of your customers. For many Ontario organizations it&rsquo;s also an AODA obligation. Building it in is far cheaper than retrofitting it after a complaint.',
  },
  covers: {
    heading: 'What we do',
    cards: [
      { title: 'AODA / WCAG audit', body: 'A practical review of your site against WCAG 2.0/2.1 AA &mdash; the standard AODA points to &mdash; on real assistive technology.' },
      ...
      { title: 'Documentation', body: 'A clear record of what was done and the standard met &mdash; useful if anyone ever asks.' },
      { title: 'Ongoing compliance', body: 'Accessibility drifts as content changes; we can keep it maintained &mdash; see <a href="/services/managed-website-growth">managed growth</a>.' },
    ],
  },
  how: {
    ...
    steps: [
      ...
      { title: 'Prioritise', body: 'You get a ranked fix list &mdash; highest impact, lowest effort first.' },
  ...
  faqs: {
    ...
    items: [
      ...
      { q: 'Isn&rsquo;t an automated accessibility checker enough?', a: 'No &mdash; automated scanners catch only a fraction of real issues. Genuine accessibility needs testing with keyboards and screen readers, which is what we do.' },
    ],
  },
  final: {
    heading: 'Make your site work for everyone.',
    body: 'Start with an audit, or build it in from the ground up &mdash; either way, let&rsquo;s scope it.',
  },
};
