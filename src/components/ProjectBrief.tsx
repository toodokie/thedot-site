                            ...
                            <div className="tabs-layout_component w-form">
                              <form id="wf-form-Website-Form" name="wf-form-Website-Form" data-name="Website Form" redirect="/" data-redirect="/" method="get" className="website-form" data-wf-page-id="650e3ca06cf62f0b69c35e31" data-wf-element-id="fedee880-7b4d-c63e-75bd-9f4fb22a3840">
                                <div className="w-layout-blockcontainer form-container-web-section w-container">
                                  ...
                                  <div className="w-layout-blockcontainer form-container w-container">
                                    <h2 className="dot_forms_title sites">1/6 Company&apos;s Info:</h2>
                                  ...
                                  <div className="w-layout-blockcontainer form-container w-container">
                                    <h2 className="dot_forms_title sites">2/6 <strong className="bold-text-7">Core Business Activities</strong>:</h2>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">3/6 Website Development Preferences</h2>
                                    
                                    <div className="dot_field_label">Current Website</div>
                                    ...
                                    <div className="dot_field_label">Biggest Website Challenge</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Success Metrics</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">What Type of Website Are You Interested In?</div>
                                    ...
                                    <div className="dot_field_label">Domain&apos;s Address, if applicable<span className="text-span-38"></span></div>
                                    ...
                                    <div className="dot_field_label">What do you think could set your website apart from others in your niche?</div>
                                    ...
                                    <div className="dot_field_label">Expected action from the website visitor</div>
                                    ...
                                    <div className="dot_field_label">Approximate Number of Pages</div>
                                    ...
                                    <div className="dot_field_label">Website Structure with Section Titles</div>
                                    ...
                                    <div className="dot_field_label">Desired Content Blocks on the Main Page</div>
                                    ...
                                    <div className="dot_field_label">Desired Content Blocks on Other Pages</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">4/6 Design & Contents</h2>
                                    <div className="dot_field_label">Please indicate what elements of corporate identity your company has</div>
                                    ...
                                    <div className="dot_field_label">Examples of websites you like (try to note what exactly caught your attention)</div>
                                    ...
                                    <div className="dot_field_label">Examples of websites you do not like (try to specify the reasons)</div>
                                    ...
                                    <div className="dot_field_label">Will there be a need for creating and selecting visual content for the website (photos, illustrations, 3D graphics, etc.)?</div>
                                    ...
                                    <div className="dot_field_label">Overall style and mood (for example, modern/ elegant/ bright/ minimalistic/classic, etc.)</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">5/6 Functional Features</h2>
                                    <div className="dot_field_label">What embedded elements are necessary for the website (select multiple if required)</div>
                                    ...
                                    <div className="dot_field_label">How often do you plan to update the content on the website?</div>
                                    ...
                                    <div className="dot_field_label">Who will be responsible for updating the content?</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">6/6 General information about the project:</h2>
                                    <div className="dot_field_label">Desired launch date for the website?</div>
                                    ...
                                    <div className="dot_field_label">Approximate Budget</div>
                            ...
                            <div className="tabs-layout_component w-form">
                              <form id="wf-form-Webdesign-Form" name="wf-form-Webdesign-Form" data-name="Webdesign Form" redirect="/" data-redirect="/" method="get" className="webdesign-form" data-wf-page-id="650e3ca06cf62f0b69c35e31" data-wf-element-id="0d26b044-80d0-a38f-eccd-c3ce5a46d3e2">
                                <div className="w-layout-blockcontainer form-container-web-section w-container">
                                  ...
                                  <div className="w-layout-blockcontainer form-container w-container">
                                    <h2 className="dot_forms_title sites">1/5 Company&apos;s Info:</h2>
                                    <div className="dot_field_label"><strong className="bold-text-6">Business Sector</strong></div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container w-container">
                                    <h2 className="dot_forms_title sites">2/5 <strong className="bold-text-7">Core Business Activities</strong>:</h2>
                                    <div className="dot_field_label"><strong className="bold-text-8">Products/Services Offered</strong></div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">3/5 Preferences:</h2>
                                    
                                    <div className="dot_field_label">Brand Maturity</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Usage Timeline</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Internal Resources</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Type of Design Service Required:</div>
                                    ...
                                    <div className="dot_field_label">What adjectives would you use to describe the desired style? (e.g., modern, traditional, playful, elegant)</div>
                                    ...
                                    <div className="dot_field_label">Are there any specific color schemes you&apos;re interested in?</div>
                                    ...
                                    <div className="dot_field_label">Do you have existing brand guidelines that the design needs to adhere to?</div>
                                    ...
                                    <div className="dot_field_label">What is the primary message you want the design to convey?</div>
                                    ...
                                    <div className="dot_field_label">Do you have preferred fonts or typography?</div>
                                    ...
                                    <div className="dot_field_label">Do you have examples of designs you love? What do you love about them?</div>
                                    ...
                                    <div className="dot_field_label">Are there designs you dislike? What elements are unappealing to you?</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">4/5 Contents</h2>
                                    <div className="dot_field_label">Are there any specific elements that must be included? (e.g., QR code, social media icons)</div>
                                    ...
                                    <div className="dot_field_label">What is the call-to-action, if applicable?</div>
                                    ...
                                    <div className="dot_field_label">What file formats do you require? (e.g., JPEG, PNG, SVG)</div>
                                    ...
                                    <div className="dot_field_label">What are the dimensions or layout restrictions? (e.g., print size, digital dimensions)</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">5/5 General information about the project:</h2>
                                    <div className="dot_field_label">What is your targeted completion date for the graphic design project?</div>
                          ...
                          <div className="tabs-layout_content">
                            <div className="tabs-layout_component w-form">
                              <form id="wf-form-Photo-Form" name="wf-form-Photo-Form" data-name="Photo Form" redirect="/" data-redirect="/" method="get" className="photo-form" data-wf-page-id="650e3ca06cf62f0b69c35e31" data-wf-element-id="0d26b044-80d0-a38f-eccd-c3ce5a46d3e2">
                                <div className="w-layout-blockcontainer form-container-web-section w-container">
                                  <h2 className="brief-title">Photo & Video Brief</h2>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">3/6 Project Preferences:</h2>
                                    
                                    <div className="dot_field_label">Content Library Needs</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Distribution Channels</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Production Scale</div>
                                    <label className="radio-button-field w-radio">
                                    ...
                                    <div className="dot_field_label">Type of Photo/Video Service Required:</div>
                                    ...
                                    <div className="dot_field_label">What is the primary purpose of this photo/video content?</div>
                                    ...
                                    <div className="dot_field_label">Where will the shooting take place? (studio, on-location, specific venue)</div>
                                    ...
                                    <div className="dot_field_label">Estimated duration of the shoot/final video length</div>
                                    <input className="text-filed-3 w-input" maxLength={256} name="duration" data-name="Duration" placeholder="" type="text" id="duration" />
                                    
                                    <div className="dot_field_label">How many people will be involved in the shoot? (talent, staff, etc.)</div>
                                    ...
                                    <div className="dot_field_label">Any special equipment or setup requirements?</div>
                                    ...
                                    <div className="dot_field_label">Style preferences (e.g., candid, formal, creative, documentary)</div>
                                    ...
                                    <div className="dot_field_label">Reference examples of photo/video styles you love</div>
                                    ...
                                    <div className="dot_field_label">Examples of styles you want to avoid</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">4/6 Technical Requirements:</h2>
                                    <div className="dot_field_label">For video: required resolution and frame rate (e.g., 4K, 1080p, 60fps)</div>
                                    ...
                                    <div className="dot_field_label">Audio requirements (voiceover, background music, ambient sound)</div>
                                    ...
                                    <div className="dot_field_label">Editing style preferences (fast-paced, smooth transitions, minimal editing)</div>
                                    ...
                                    <div className="dot_field_label">Music/soundtrack preferences</div>
                                    ...
                                    <div className="dot_field_label">Branding elements to include (logo placement, colors, graphics)</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">5/6 Logistics:</h2>
                                    <div className="dot_field_label">Preferred shooting dates or time constraints</div>
                                    ...
                                    <div className="dot_field_label">Timeline for final delivery</div>
                                    <input className="text-filed-3 w-input" maxLength={256} name="timeline" data-name="Timeline" placeholder="" type="text" id="timeline" />
                                    
                                    <div className="dot_field_label">Any special requirements or considerations</div>
                                  ...
                                  <div className="w-layout-blockcontainer form-container-web w-container">
                                    <h2 className="dot_forms_title sites">6/6 General information about the project:</h2>
                                    <div className="dot_field_label">Project completion deadline</div>
