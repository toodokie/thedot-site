...
export default function WelcomeSection() {
    return (
      ...
      <style jsx>{`
        ...
        @media (width >= 1240px) {
          section h2 {
            font-size: 2.6rem !important; /* Further scale for large screens */
          }
          section h3 {
